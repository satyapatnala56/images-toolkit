...
function convert_webp() {
  ...
  function starting_initial_conversion(message1, message2, value) {
    ...
    var quality = document.querySelector('#resize_quality select').value || 1
    var width = document.querySelector('#resize_width input').value || img.width
  ...
  function converting_process(
    ...
    document.querySelector('#output_div_inner img').onload = function () {
      document.querySelector('.success_alert').style.borderColor = '#badbcc'
      document.querySelector('.success_alert').style.color = '#0f5132'
      document.querySelector('.success_alert').style.background = '#d1e7dd'
      ...
      function image_saving(file_name, mimetype) {
        ...
        document.querySelector('.container2').style.background = 'transparent'
    ...
    r.onload = function () {
      ...
      img.onload = function () {
        ...
        if (type_dimesions === 'pixels') {
          ...
          for (var option of document.getElementById('dimensions_div_pixcel')
            .options) {
          ...
          console.log(drop_data)
          for (var option of document.getElementById('dimensions_div_inches')
            .options) {
            if (option.value === drop_data) {
              option.selected = true
            }
        ...
        inches.addEventListener('change', (e) => {
          ...
          if (value) {
            document.querySelector('#resize_height input').value =
              parseInt(button_height)
            document.querySelector('#resize_width input').value =
              parseInt(button_width)
