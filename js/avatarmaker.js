//css
var item = document.getElementById("menu_list");
...
function downloader(){
  ...
  let downloadavatar=document.querySelector("#avatar");
  domtoimage.toPng(downloadavatar)
    .then(function (dataUrl) {
        var img = new Image();
        img.src = dataUrl;
        var link = document.createElement('a');
        link.download = `safeimagekit-avatar`;
        link.href = dataUrl;
        link.click();
    })
...
$(document).ready(function() {
    ...
    random();
    document.querySelector("#download").addEventListener("click",downloader)
})
function random() {
