      ...
      [
        {
          ...
          value: function parseOptions(opts) {
            ...
            return {
              ...
              onInitialize: defaultValue(
                onInitialize,
                defaults$$1.onInitialize
              ),
  ...
  var Croppr$1 = (function (_CropprCore) {
    ...
    function Croppr(element, options) {
      ...
      return possibleConstructorReturn(
        this,
        (Croppr.__proto__ || Object.getPrototypeOf(Croppr)).call(
          this,
          element,
          options,
          _deferred
    ...
    createClass(Croppr, [
      {
        ...
        value: function getValue(mode) {
          return get(
            Croppr.prototype.__proto__ ||
              Object.getPrototypeOf(Croppr.prototype),
            "getValue",
            this
          ).call(this, mode);
        },
