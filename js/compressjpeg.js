...
document.querySelector("#compress_strict").onchange = function () {
  if (document.querySelector("#compress_strict").checked == true) {
    ...
    document.querySelector("#compress_strictBtn").style.background =
      "transparent";
  }
};
document.querySelector("#orientation").onchange = function () {
  if (document.querySelector("#orientation").checked == true) {
    ...
    document.querySelector("#orientationBtn").style.background = "transparent";
  }
};
var input;
...
function compressImage() {
  ...
  reader.onload = function () {
    document.querySelector("#rightDiv #outputDiv div img").src = reader.result;
        ...
        new Compressor(input, {
          ...
          success(result) {
            ...
            document.querySelector("#save").onclick = function () {
              ...
              document.querySelector(".box").style.background = "#33cccc";
